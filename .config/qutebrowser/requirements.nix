...
#
# COMMAND:
#   pypi2nix -V 3 -e jedi -e json-rpc -e service_factory -e flake8
#
...
let
  ...
  generated = self: {
    ...
    "json-rpc" = python.mkDerivation {
      name = "json-rpc-1.11.0";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/63/9e/b0ca2c9c7d6d39b94bb4ebac064f8529204267f0ec4a4af576203157bd8b/json-rpc-1.11.0.tar.gz"; sha256 = "a5e53f80699e97754bfd8a29c86138aa144c4e6663fe80c0be5270fc6f177166"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
    ...
    "service-factory" = python.mkDerivation {
      ...
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/d1/32/bacd539bc748af613082f8cf80c82311373a05bb4af2d43bc2ff5bbdcdcc/service_factory-0.1.5.tar.gz"; sha256 = "3f23f6e1a59eb2657eff48be5ee42e4cbd8f90eb3d134eab0017e13c54f6e3f7"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
