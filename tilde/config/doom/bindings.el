...
(map! :leader
      ...
      (:desc "window" :prefix "w"
        :desc "Delete other windows" :n "1" #'delete-other-windows
      ...
      (:desc "code" :prefix "c"
        ...
        :desc "Open REPL"                 :n  "r" #'+eval/open-repl
                                          :v  "r" #'+eval:repl)
      (:desc "directories" :prefix "d"
        :desc "fd find file/dir"        :n "d"   #'fd-dired)
      ...
      (:desc "help" :prefix "h"
        ...
        :n "SPC" #'which-key-show-top-level)
      ...
      (:desc "quit" :prefix "q"
        :desc "Quit Emacs"             :n "q" #'save-buffers-kill-emacs
      ...
      (:desc "toggle" :prefix "t"
        ...
        :desc "Fill column indicator"  :n "c" #'fci-mode
